...
screen_main_cont_days.set_pos(5, 53)
...
screen_main_text_day.set_pos(0, 1)
screen_main_text_day.set_size(199, 59)
...
screen_main_cont_time.set_pos(-20, 8)
...
screen_main_text_time_span = screen_main_text_time.new_span()
screen_main_text_time_span.set_text("00")
screen_main_text_time_span.style.set_text_color(lv.color_hex(0x26B08C))
screen_main_text_time_span.style.set_text_decor(lv.TEXT_DECOR.NONE)
screen_main_text_time_span.style.set_text_font(test_font("YournameD7CentralNarrow", 40))
screen_main_text_time_span = screen_main_text_time.new_span()
screen_main_text_time_span.set_text(":")
...
screen_setting.set_style_bg_color(lv.color_hex(0x589bcc), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_setting_tileview_setting.set_pos(10, 20)
screen_setting_tileview_setting.set_size(300, 200)
...
screen_setting_tileview_setting.set_style_bg_opa(98, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_tileview_setting.set_style_bg_color(lv.color_hex(0xa7a4a4), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_setting_tileview_setting.set_style_bg_opa(188, lv.PART.SCROLLBAR|lv.STATE.DEFAULT)
screen_setting_tileview_setting.set_style_bg_color(lv.color_hex(0x5b8438), lv.PART.SCROLLBAR|lv.STATE.DEFAULT)
screen_setting_tileview_setting.set_style_radius(0, lv.PART.SCROLLBAR|lv.STATE.DEFAULT)

# Create screen_setting_list_1
screen_setting_list_1 = lv.list(screen_setting_tileview_setting_tile_main)
screen_setting_list_1_item0 = screen_setting_list_1.add_btn("B:MicroPython/_wifi1_alpha_20x20.bin", "WIFI")
screen_setting_list_1_item1 = screen_setting_list_1.add_btn("B:MicroPython/_bluetooth30_30_alpha_20x20.bin", "BLE")
screen_setting_list_1.set_pos(27, 16)
screen_setting_list_1.set_size(250, 170)
screen_setting_list_1.set_scrollbar_mode(lv.SCROLLBAR_MODE.OFF)
# Set style for screen_setting_list_1, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
screen_setting_list_1.set_style_pad_top(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_pad_left(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_pad_right(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_pad_bottom(5, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_bg_opa(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_border_width(1, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_border_opa(255, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_border_color(lv.color_hex(0xe1e6ee), lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_border_side(lv.BORDER_SIDE.NONE, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_radius(3, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_shadow_width(0, lv.PART.MAIN|lv.STATE.DEFAULT)

# Set style for screen_setting_list_1, Part: lv.PART.SCROLLBAR, State: lv.STATE.DEFAULT.
screen_setting_list_1.set_style_radius(3, lv.PART.SCROLLBAR|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_bg_opa(255, lv.PART.SCROLLBAR|lv.STATE.DEFAULT)
screen_setting_list_1.set_style_bg_color(lv.color_hex(0xffffff), lv.PART.SCROLLBAR|lv.STATE.DEFAULT)
# Set style for screen_setting_list_1, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
style_screen_setting_list_1_extra_btns_main_default = lv.style_t()
style_screen_setting_list_1_extra_btns_main_default.init()
style_screen_setting_list_1_extra_btns_main_default.set_pad_top(5)
style_screen_setting_list_1_extra_btns_main_default.set_pad_left(5)
style_screen_setting_list_1_extra_btns_main_default.set_pad_right(5)
style_screen_setting_list_1_extra_btns_main_default.set_pad_bottom(5)
style_screen_setting_list_1_extra_btns_main_default.set_border_width(0)
style_screen_setting_list_1_extra_btns_main_default.set_text_color(lv.color_hex(0x0D3055))
style_screen_setting_list_1_extra_btns_main_default.set_text_font(test_font("Abel_regular", 12))
style_screen_setting_list_1_extra_btns_main_default.set_radius(3)
style_screen_setting_list_1_extra_btns_main_default.set_bg_opa(44)
style_screen_setting_list_1_extra_btns_main_default.set_bg_color(lv.color_hex(0xd04545))
screen_setting_list_1_item1.add_style(style_screen_setting_list_1_extra_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_setting_list_1_item0.add_style(style_screen_setting_list_1_extra_btns_main_default, lv.PART.MAIN|lv.STATE.DEFAULT)
# Set style for screen_setting_list_1, Part: lv.PART.MAIN, State: lv.STATE.PRESSED.
style_screen_setting_list_1_extra_btns_main_pressed = lv.style_t()
style_screen_setting_list_1_extra_btns_main_pressed.init()
style_screen_setting_list_1_extra_btns_main_pressed.set_pad_top(5)
style_screen_setting_list_1_extra_btns_main_pressed.set_pad_left(5)
style_screen_setting_list_1_extra_btns_main_pressed.set_pad_right(5)
style_screen_setting_list_1_extra_btns_main_pressed.set_pad_bottom(5)
style_screen_setting_list_1_extra_btns_main_pressed.set_border_width(0)
style_screen_setting_list_1_extra_btns_main_pressed.set_radius(3)
style_screen_setting_list_1_extra_btns_main_pressed.set_text_color(lv.color_hex(0x0D3055))
style_screen_setting_list_1_extra_btns_main_pressed.set_text_font(test_font("Abel_regular", 12))
style_screen_setting_list_1_extra_btns_main_pressed.set_bg_opa(88)
style_screen_setting_list_1_extra_btns_main_pressed.set_bg_color(lv.color_hex(0x29ff00))
screen_setting_list_1_item1.add_style(style_screen_setting_list_1_extra_btns_main_pressed, lv.PART.MAIN|lv.STATE.PRESSED)
screen_setting_list_1_item0.add_style(style_screen_setting_list_1_extra_btns_main_pressed, lv.PART.MAIN|lv.STATE.PRESSED)
# Set style for screen_setting_list_1, Part: lv.PART.MAIN, State: lv.STATE.FOCUSED.
style_screen_setting_list_1_extra_btns_main_focused = lv.style_t()
style_screen_setting_list_1_extra_btns_main_focused.init()
style_screen_setting_list_1_extra_btns_main_focused.set_pad_top(5)
style_screen_setting_list_1_extra_btns_main_focused.set_pad_left(5)
style_screen_setting_list_1_extra_btns_main_focused.set_pad_right(5)
style_screen_setting_list_1_extra_btns_main_focused.set_pad_bottom(5)
style_screen_setting_list_1_extra_btns_main_focused.set_border_width(0)
style_screen_setting_list_1_extra_btns_main_focused.set_radius(3)
style_screen_setting_list_1_extra_btns_main_focused.set_text_color(lv.color_hex(0x0D3055))
style_screen_setting_list_1_extra_btns_main_focused.set_text_font(test_font("Abel_regular", 12))
style_screen_setting_list_1_extra_btns_main_focused.set_bg_opa(255)
style_screen_setting_list_1_extra_btns_main_focused.set_bg_color(lv.color_hex(0x55acaa))
screen_setting_list_1_item1.add_style(style_screen_setting_list_1_extra_btns_main_focused, lv.PART.MAIN|lv.STATE.FOCUSED)
screen_setting_list_1_item0.add_style(style_screen_setting_list_1_extra_btns_main_focused, lv.PART.MAIN|lv.STATE.FOCUSED)
# Set style for screen_setting_list_1, Part: lv.PART.MAIN, State: lv.STATE.DEFAULT.
style_screen_setting_list_1_extra_texts_main_default = lv.style_t()
style_screen_setting_list_1_extra_texts_main_default.init()
style_screen_setting_list_1_extra_texts_main_default.set_pad_top(5)
style_screen_setting_list_1_extra_texts_main_default.set_pad_left(5)
style_screen_setting_list_1_extra_texts_main_default.set_pad_right(5)
style_screen_setting_list_1_extra_texts_main_default.set_pad_bottom(5)
style_screen_setting_list_1_extra_texts_main_default.set_border_width(0)
style_screen_setting_list_1_extra_texts_main_default.set_text_color(lv.color_hex(0x0D3055))
style_screen_setting_list_1_extra_texts_main_default.set_text_font(test_font("Abel_regular", 12))
style_screen_setting_list_1_extra_texts_main_default.set_radius(3)
style_screen_setting_list_1_extra_texts_main_default.set_bg_opa(161)
style_screen_setting_list_1_extra_texts_main_default.set_bg_color(lv.color_hex(0xffffff))
